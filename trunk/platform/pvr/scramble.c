/* This is Marcus Comstedt's scramble.c with a couple of minor changes
 * that don't impact functionality at all.  You should have the binary
 * I use on my Debian system, but I include this here in case my binary
 * doesn't work on your system (eg, if you use cygwin).
 */
#include <stdio.h>
#include <stdlib.h>
